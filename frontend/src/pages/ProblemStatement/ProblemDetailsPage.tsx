              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <div className="mt-6 relative">
                    ...
                    Ravi, a curious student, wanted to build a chatbot that could answer his classmates' questions before exams.
                    He started with simple rule-based replies, but soon added AI using a language model to make it smarter.
                    After weeks of tweaking and late-night debugging, the bot could even suggest solutions and explain concepts.
                    Soon, everyone in his class started using it — and Ravi became known as the "Chatbot Prodigy" of his batch.
                    </p>
