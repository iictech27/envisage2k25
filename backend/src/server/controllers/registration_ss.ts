...
import { ReqSSRegistrationOrderBody,  ResSSRegistrationBody } from "../bodies/registration_ss.js";
...
export const createRegistration: RequestHandler<unknown, unknown, ReqSSRegistrationOrderBody, unknown> = async (req, res, next) => {
    ...
    try {
        ...
        if(typeof cloudinaryRes === "string") {
            throw createHttpError(httpCodes["500"].code, httpCodes["500"].message + ": " + cloudinaryRes);
        }
