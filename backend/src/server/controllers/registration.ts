...
import { ReqRegistrationBody, ResRegistrationBody, ResUserRegistrationsBody } from "../bodies/registration.js";
...
export const getUserRegistrations: RequestHandler = async (req, res, next) => {
    try {
        ...
        const response: ResUserRegistrationsBody = {
            status: httpCodes["201"].code,
            message: httpCodes["201"].message,
            events: events,
