...
function mailOptions(toEmail: string): MailOptions {
    return {
...
Congratulations! Your registration has been verified and successfully completed. Thank you for registering for our events. 
  ...
  html: `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; overflow: hidden;">
      ...
      <div style="padding: 16px;">
        ...
        <p style="font-size: 16px;">We are pleased to inform you that your registration has been verified and is now successful. Thank you for registering for our events.</p>
