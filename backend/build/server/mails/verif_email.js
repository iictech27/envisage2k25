...
function mailOptions(toEmail, otp) {
    return {
...
Admin Team`,
    ...
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; overflow: hidden;">
      ...
      <div style="padding: 16px;">
        ...
        <p style="font-size: 16px;">If you arent already redirected to the verfication page click on this <a href="${validatedEnv.CLIENT_LINK + "/verify-email?otp=sent&msg=spam"}">LINK</a></p>
