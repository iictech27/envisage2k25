...
export const signUp = async (req, res, next) => {
    ...
    try {
        ...
        if (userWithEmail) {
            throw createHttpError(httpCodes["409"].code, httpCodes["409"].message +
...
export const verifyEmail = async (req, res, next) => {
    ...
    try {
        ...
        if (!sessionToken) {
            throw createHttpError(httpCodes["400"].code, httpCodes["400"].message +
        ...
        // otp has expired
        if (difference <= 0) {
            throw createHttpError(httpCodes["403"].code, httpCodes["403"].message +
...
export const getRegEvents = async (req, res, next) => {
    try {
